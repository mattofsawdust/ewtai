...
def create_pdf_report(symbol, data, summary=None, prediction=None, analysis_type="Basic"):
    """Generate a PDF report with analysis details"""
    # Keep track of temp files to clean up later
    temp_files_to_cleanup = []
    
    # Generate static tables instead of charts (which don't display in Safari PDF)
    # This is much more reliable across browsers
            ...
            if df is not None:
                ...
                if summary:
                    ...
                    with elliott_tab:
                        ...
                        # Add a visualization of the Elliott Wave pattern
                        st.markdown("""
                        <h4>Elliott Wave Pattern Key</h4>
                        <div style="background-color: #f8f9fa; padding: 15px; border-radius: 5px; margin-bottom: 20px;">
                        <p>A typical 5-wave Elliott impulse pattern followed by an A-B-C correction:</p>
                        ...
                        Price
                          ...
                          | /         (A)       /
                          |/                   /
                          |___________________(C)________________
                                                               Time
                        </pre>
                        <p><b>Wave numbering:</b> Impulse waves are numbered 1-5, corrective waves are labeled A-B-C</p>
                        </div>
                        """, unsafe_allow_html=True)
                        
                        # Add a note about drawing Elliott Wave patterns manually 
                        st.markdown("""
                        <div style='background-color: #EBF5FB; padding: 10px; border-radius: 5px; margin-bottom: 15px;'>
                        <p><strong>Note:</strong> TradingView's interactive chart allows you to manually draw Elliott Wave patterns. 
                        Use the chart's drawing tools to mark wave counts and other technical patterns.</p>
                        
                        <p>To mark Elliott Waves:</p>
                        <ol>
                            <li>Click the <strong>Drawing Tools</strong> icon in the toolbar</li>
                            <li>Look for the Elliott Wave tools in the menu (we've enabled Elliott Impulse Wave, Correction Wave, etc.)</li>
                            <li>Select the appropriate Elliott Wave tool for the pattern you want to annotate</li>
                            <li>Click on the chart where you want to place the wave pattern</li>
                            <li>Adjust the wave points as needed to match the price action</li>
                        </ol>
                    ...
                    try:
                        ...
                        report_bytes = generate_pdf_bytes(symbol, df, summary)
